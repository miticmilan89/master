...
<%@ taglib prefix="sec" uri="http://www.springframework.org/security/tags" %>
		...
		<form id="loginForm3" name="f" action="<c:url value="/app/login-process"/>" method="post" autocomplete="off" >
			<div style="padding-top:20px; text-align: center">
	                	...
	                	<div class="row" style="font-weight: bold; text-align: center; padding-bottom:5px;">
			                ...
			                <input class="column-data"  autofocus="autofocus" type="text" name="username" placeholder="<spring:message code="label.username"/>" value="<c:out   escapeXml="false" value="${param.username}"/>"/><br/>
