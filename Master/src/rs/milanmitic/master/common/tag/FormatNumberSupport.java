...
public abstract class FormatNumberSupport extends BodyTagSupport {
	...
	private static final Logger log = LogManager.getLogger(FormatNumberSupport.class);
	...
	private Object checkInput(Object input) throws JspException {
		/*
	...
	private String doEndPrepare(Object input) throws JspException {
		String formatted;
		NumberFormat formatter = Utils.getDecimalFormat(pageContext.getSession());
		if (formatter != null) {
			if (((pattern != null) && !"".equals(pattern)) || CURRENCY.equalsIgnoreCase(type)) {
	...
	/*
	 * Applies the 'groupingUsed', 'maxIntegerDigits', 'minIntegerDigits', 'maxFractionDigits', and 'minFractionDigits' attributes to the given formatter.
	 */
	 ...
	 * 
	 * If both "currencyCode" and "currencySymbol" are present, "currencyCode" takes precedence over "currencySymbol" if the java.util.Currency class is defined in the container's runtime (that is, if the container's runtime is J2SE 1.4 or greater),
	 * and "currencySymbol" takes precendence over "currencyCode" otherwise.
	 * 
	 ...
	 */
	private void setCurrency(NumberFormat formatter) throws JspException  {
		String code = null;
		String symbol = null;
